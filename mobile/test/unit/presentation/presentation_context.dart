...
class PresentationContext {
  ...
  /// Fork-only, see FORK.md. Owners whose assets the current user was granted permission to delete.
  Set<String> partnerDeleteGrants = {};

  List<Override> get overrides => [
    driftProvider.overrideWithValue(_mockDrift()),
    partnerPermissionsProvider.overrideWith((ref) async => PartnerPermissions(grantedToMe: partnerDeleteGrants)),
